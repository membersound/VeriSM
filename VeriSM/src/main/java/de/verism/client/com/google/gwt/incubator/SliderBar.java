package de.verism.client.com.google.gwt.incubator;

/**
 *  IMPORTANT. This is as the GWT.Slider class ported from GWT Incubator project to compile with latest GWT 2.5.1 version,
 * as the slider is not yet included in official GWT SDK.
 */
